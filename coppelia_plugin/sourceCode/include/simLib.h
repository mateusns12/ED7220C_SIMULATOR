...
typedef int (__cdecl *ptrSimRegisterScriptVariable)(const char* var,const char* value,int stackHandle);
...
typedef int (__cdecl *ptrSimPushTextOntoStack)(int stackHandle,const char* value);
typedef int (__cdecl *ptrSimPushStringOntoStack)(int stackHandle,const char* value,int stringSize);
typedef int (__cdecl *ptrSimPushBufferOntoStack)(int stackHandle,const char* value,int stringSize);
...
typedef int (__cdecl *ptrSimGetStackItemType)(int stackHandle,int cIndex);
typedef int (__cdecl *ptrSimGetStackStringType)(int stackHandle,int cIndex);
...
typedef int (__cdecl *ptrSimCreateScript)(int scriptType,const char* scriptText, int options, const char* lang);
